...
\subsection{Tabla colectores disponible de RouteViews Project}
...
\hline
\end{tabular}
\caption{Tabla colectores disponible de RouteViews Project}
\label{tab:tabla_colectores_routeviews}
...
\subsection{Tabla colectores disponible de RIPE RIS}
...
\hline
\end{tabular}
\caption{Tabla colectores disponible de RIPE RIS}
\label{tab:tabla_colectores_ripe_ris}
\end{table}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        ...
        \label{fig:distribucion_as_grado_salida_febrero_boxplot_sin_outliers_anexo}
    \end{subfigure}
...
\section{Cantidad de ASes y enlaces en dataset de evaluación} \label{sec:attr_asrank_section}
...
\end{tabular}
\label{tab:asrank_datasets_anexo_repetido}
\end{table}
