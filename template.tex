...
\AddToHook{shipout/before}{\stepcounter{templatePageCounter}}
...
\hypersetup{
	...
	pdfinfo={
		...
		Template.Version.Dev={3.4.2-THS},
		Template.Version.Hash={3DC340965496D63A6A555F847DD184B9},
		Template.Version.Release={3.4.2},
	...
	pdfproducer={Template-Tesis v3.4.2 | (Pablo Pizarro R.) ppizarror.com},
...
% -----------------------------------------------------------------------------
\AtBeginEnvironment{tabular}{\global\rownum=0\relax}
\AtBeginEnvironment{tabularx}{\global\rownum=0\relax}
...
\newcommand{\templateIndex}{%
	...
	\ifthenelse{\equal{\showborderonlinks}{true}}{%
		\hypersetup{%
			linkbordercolor=\linkcolorindex
		}
	}{%
		\hypersetup{%
			linkcolor=\linkcolorindex
		}
	}
	...
	\ifthenelse{\equal{\showborderonlinks}{true}}{% Actualiza colores
		\hypersetup{%
			linkbordercolor=\linkcolor
		}
	}{%
